        ...
        <View className="relative justify-center">
          ...
          <View className="absolute w-full h-full flex flex-col justify-between top-0">
            <View className="flex justify-center items-center h-4/6">
              <Image
                className="w-24 h-28 mt-40"
                source={require("../../assets/icon-blog.png")}
              />
            </View>
            <View className="self-center  bottom-4" style={{height: 250}}>
              ...
              <View className="flex-row justify-between mt-10">
                ...
                <Text className="text-white font-bold text-[14px]" style={{ fontFamily: "Poppins_500Medium" }}>Sign Up?</Text>
                </Pressable>
